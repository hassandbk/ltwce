...
<html lang="en">
  ...
  <body
    class="tracking-tight text-slate-800 antialiased font-inter bg-white"
    x-data="supportApp()"
    x-init="init()"
    x-cloak
  >
        ...
        <section class="relative">
          ...
          <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="pt-32 sm:pt-40 pb-20 sm:pb-44">
              <div
                class="md:flex md:items-center md:space-x-8 lg:space-x-20 mx-auto"
              >
                <!-- Content -->
                <div
                  class="w-full md:w-1/2 space-y-6 text-center md:text-left"
                  data-aos="fade-right"
                >
                  <h1
                    class="font-playfair text-4xl md:text-5xl font-bold text-white leading-tight mb-4"
                  >
                    LTWCE Co-op –
                    <span class="text-emerald-500"
                      >Empowering Our Community</span
                    >
                  </h1>
                ...
                <div
                  x-data="{ open: false }"
                  class="mt-12 md:mt-0 w-full md:w-1/2 flex justify-center"
                  data-aos="fade-left"
                >
                  <div class="relative">
                    <!-- gradient overlay -->
                    <div
                      aria-hidden="true"
                      class="absolute inset-0 bg-gradient-to-tr from-black via-transparent to-black rounded-lg"
                    ></div>
                    <img
                    src="<?= base_url('assets/images/hero-image-01.jpg'); ?>"
                    ...
                    >
                      <svg
                        class="w-16 h-16 md:w-20 md:h-20 fill-current"
                        viewBox="0 0 88 88"
                    ...
                    >
                      ...
                      >
                        <video
                          x-init="$watch('open', val => val ? $el.play() : $el.pause())"
                          class="w-full h-auto"
                          controls
                          loop
                        >
        ...
        <section class="py-16 bg-white">
          <div class="container mx-auto px-4">
            ...
            <div aria-hidden="true" class="relative mb-12">
              <div
                class="absolute inset-0 flex justify-center space-x-4 opacity-20"
              >
            ...
            >
              <template x-for="f in features" :key="f.title">
                ...
                >
                  ...
                  >
                    <i
                      :class="`${f.icon} text-2xl transition-colors duration-200 ${f.fg}`"
                    ></i>
                  </div>
                  <h3
                    class="text-xl font-semibold transition-colors duration-200 group-hover:text-blue-600"
                    x-text="f.title"
                  ></h3>
                  <p
                    class="text-slate-600 max-w-xs transition-colors duration-200 group-hover:text-slate-800"
          ...
          <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <template x-if="services.length">
              ...
              >
                ...
                <div
                  x-ref="track"
                  class="flex space-x-6 will-change-transform"
                  :style="{
            ...
            <div class="text-center mt-8" x-show="services.length">
              <a
                href="services.html"
                class="px-6 py-3 bg-yellow-500 text-white rounded hover:bg-yellow-600 transition"
              >
                View More
              </a>
            </div>
    ...
    <div class="py-12 md:py-20">
      ...
      <div class="space-y-8" x-cloak>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          <template x-for="t in tabs" :key="t.id">
            <button
              @click="tab = t.id"
              :class="tab === t.id ? 'text-slate-800' : 'text-slate-500'"
            ...
            >
              ...
              >
                <i
                  :class="`${t.icon} text-2xl transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-3 ${tab === t.id ? 'text-blue-600' : 'text-gray-400'}`"
                ></i>
              </div>
        ...
        <section class="relative overflow-hidden">
          ...
          <div
            class="container mx-auto px-4 relative z-20 grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 pb-16"
          >
            <!-- Card 1 -->
            <article class="relative max-w-sm mx-auto group">
              ...
              >
                ...
                <img
                src="<?= base_url('assets/images/features-home-3-01.jpg'); ?>" 
                 
                  alt="Full Audit Trail"
                  class="w-full block"
                />
            ...
            <!-- Card 2 -->
            <article
              class="relative max-w-sm mx-auto group"
              data-aos="fade-up"
              data-aos-delay="100"
            >
              <div
              ...
              >
                ...
                <img
                src="<?= base_url('assets/images/features-home-3-02.jpg'); ?>" 
            ...
            >
              ...
              >
                ...
                <img
                src="<?= base_url('assets/images/features-home-3-03.jpg'); ?>" 
        ...
        <section class="py-16 bg-slate-50">
          <div class="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div class="text-center max-w-2xl mx-auto mb-12">
              <h2
                class="font-playfair text-3xl md:text-4xl font-bold text-slate-800"
              >
                LTWCE SACCO by the Numbers
              </h2>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-12">
              <ul class="flex-1 space-y-8" data-aos="fade-right">
                ...
                <li class="flex items-start space-x-4">
                  <svg
                    class="w-16 h-16 text-yellow-500 flex-shrink-0"
                    fill="currentColor"
                    viewBox="0 0 16 16"
                  >
                    <!-- icon path -->
                ...
                <li class="flex items-start space-x-4">
                  <svg
                    class="w-16 h-16 text-green-500 flex-shrink-0"
                    fill="currentColor"
                    viewBox="0 0 16 16"
                  >
                    <!-- icon path -->
                ...
                <li class="flex items-start space-x-4">
                  <svg
                    class="w-16 h-16 text-indigo-500 flex-shrink-0"
                    fill="currentColor"
                    viewBox="0 0 16 16"
                  >
                    <!-- icon path -->
              ...
              <div class="flex-1" data-aos="fade-left">
                <img
                src="<?= base_url('assets/images/target.png'); ?>" 
        ...
        <section x-data="{ showShares: false }" class="bg-white">
            ...
            <div class="mt-8 flex justify-center items-center gap-4">
              ...
              <label class="inline-flex items-center cursor-pointer">
                ...
                <input
                  ...
                  class="sr-only"
                  x-model="showShares"
                  title="Toggle share vs fee view"
                />
                <div
                  class="w-12 h-6 bg-slate-700 rounded-full relative transition-colors duration-300"
                ...
                >
                  <span
                    ...
                    :class="{ 'translate-x-6': showShares }"
                  ></span>
                </div>
              </label>
          ...
          <div class="relative -mt-24 z-10 px-4">
            <div
              class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 pb-20"
            >
              <!-- Starter Card -->
              <div
                class="bg-white rounded-lg shadow-xl transform transition hover:scale-105 hover:shadow-2xl p-6"
                data-aos="fade-up"
              >
        ...
        <section class="py-16 bg-gray-100 text-gray-900">
          <div class="max-w-3xl mx-auto px-4 text-center space-y-6">
            ...
            <div class="relative inline-block">
              ...
              <svg
                class="absolute top-0 right-0 w-16 h-12 text-yellow-400 transform translate-x-1/2 -translate-y-1/2"
                fill="currentColor"
                viewBox="0 0 56 43"
              >
                <path
      ...
      <footer class="bg-slate-900 text-slate-400">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 py-16">
          <div class="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12">
            ...
            <div>
              ...
              <ul class="space-y-2">
                ...
                <li>
                  <a href="privacy.html" class="hover:text-white"
                    >Privacy Policy</a
                  >
                </li>
              </ul>
          ...
          <div
            class="border-t border-slate-700 pt-6 flex flex-col md:flex-row items-center justify-between"
          >
...
<script src="<?= base_url('assets/js/main.js') ?>"></script>
    <script
      ...
      data-cf-beacon='{"rayId":"955b15f3eeabb910","version":"2025.6.2","r":1}'
      crossorigin="anonymous"
    ></script>
